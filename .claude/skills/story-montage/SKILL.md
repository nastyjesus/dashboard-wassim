...
1. **Urgence / alerte** — "🚨" ou "⚠️" + injonction directe ("ARRÊTE", "NE FAIS PAS", deadline)
...
- **Emoji optionnel** au tout début seulement (🚨 ⚠️ 📉 🔥 🤖 — un seul, jamais plusieurs)
...
- Le **3ᵉ sticker** peut être plus créatif (question box, slider, countdown) selon ce qui colle au ton de la vidéo.
...
- **Musique manquante** : `python fetch_music.py` (Mixkit/Pixabay CDN). Si tout échoue, déposer manuellement un MP3 chill ≥ 60s dans `assets/music_chill.mp3`.
